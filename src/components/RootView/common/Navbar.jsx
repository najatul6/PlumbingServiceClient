...
const Navbar = () => {
    ...
    const navLinks = [
        ...
        { name: "Service Areas", path: "/ServiceAreas" },
                    ...
                    <div className="container mx-auto px-4 py-3 flex flex-col gap-2">
                        {navLinks.map((link) => (
                            <NavLink
                                ...
                                to={link.path}
                                className={({ isActive }) =>
                                    `py-2 px-3 rounded-md text-sm font-medium ${isActive
                        ...
                        <div className="flex gap-3 mt-3">
                            {user ? (
                                <>
                                    <Button variant="outline" className="flex-1 gap-2" onClick={() => navigate("/dashboard/overview")}>
